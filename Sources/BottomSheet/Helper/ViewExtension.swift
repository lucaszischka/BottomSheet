...
public extension View {
    /**
     ...
     - Parameter bottomSheetPosition: A binding that saves the current state of the BottomSheet. This can be any `enum` that conforms to `CGFloat`, `CaseIterable` and `Equatable`. For more information about custom enums see `BottomSheetPosition`.
     ...
     */
    func bottomSheet<mContent: View, bottomSheetPositionEnum: RawRepresentable>(bottomSheetPosition: Binding<bottomSheetPositionEnum>, options: [BottomSheet.Options] = [], title: String? = nil, @ViewBuilder content: () -> mContent) -> some View where bottomSheetPositionEnum.RawValue == CGFloat, bottomSheetPositionEnum: CaseIterable, bottomSheetPositionEnum: Equatable {
        ZStack {
            self
