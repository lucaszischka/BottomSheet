...
/**
 The default BottomSheetPosition.
 It has the following cases and values: `top = 0.975`,  `middle = 0.4`,  `bottom = 0.125`,  `hidden = 0`.
 ...
 - The value can be anythig between `0` and `1` (`x <= 1`, `x >= 0`).
   When unsing the `.absolutePositionValue` option it can be anything above `0` (`x >= 0`).
 - The value is the height of the BottomSheet propotional to the screen height (`1 == 100% == full screen`).
   When using the`.absolutePositionValue` option the value is the height of the BottomSheet in pixel (`1 == 1px`).
 - The lowest value (greater than 0) automaticly gets the `.bottom` behavior.
   To prevent this please use the option `.noBottomPosition`
 */
...
/**
 The default BottomSheetPositionAbsolute.
 It has the following cases and values: `top = 750`,  `middle = 300`,  `bottom = 100`,  `hidden = 0`.
 
 This BottomSheetPositionAbsolute uses absolute values and requires the the`.absolutePositionValue` option.
 For relative values in pixels, see BottomSheetPosition.
